...
public class AppController {
	...
	public String addRecipe(Model model, @ModelAttribute Recipes recipe,
							...
							@RequestParam String[] steps, @RequestParam String[] skus, @RequestParam String recipeName, @RequestParam String summary, RedirectAttributes redirect) {
		...
		recipe.getInstructions().setSkus(temp3);
