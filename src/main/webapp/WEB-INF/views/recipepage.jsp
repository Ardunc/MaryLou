					...
					<c:if test="${not empty loggedInUser}">
						...
						<c:if test="${not empty activerecipe.image}">
							<img
								...
								<span><a href="#" style=" position: absolute; right: 85px; top: 325px; data-toggle="modal" data-target="#add-images"
								class="btn btn-danger"> Change Photo <i class="fa fa-pencil"></i></a></span>
