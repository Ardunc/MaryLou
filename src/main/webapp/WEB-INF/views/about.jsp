...
<head>
  <meta charset="utf-8">
  <title>MaryLou - Lets Get Cooking!</title>
  ...
  <div id="wrapper">
    ...
    <section id="content">
      <div class="container">
        <div class="row">
          <div class="span6">
            <h2>Welcome to <strong>MaryLou</strong></h2>
            <p>
              Find all of the recipes you need while easily tracking your budget.
            </p>
            <p>
              Upload your own recipes and pick out ingredients for others to use.
            </p>
            <p>
              Find your ingredients on Walmart.com to easily add them to your cart.
            </p>
          </div>
          <div class="span6">
            <!-- start flexslider -->
